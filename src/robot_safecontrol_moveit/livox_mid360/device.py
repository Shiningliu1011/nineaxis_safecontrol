...
:mod:`robot_safecontrol_moveit.livox_mid360.stream`.
...
.. warning::
   ...
   device on start; in this project that is an explicit, opt-in action (see
   ``config/perception_dual_sensor_real.yaml`` and ticket #31), never a
