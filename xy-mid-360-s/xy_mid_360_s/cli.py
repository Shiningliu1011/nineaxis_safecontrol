"""``xy-mid-360-s`` — device bring-up and diagnostics for MID-360/MID-360S.
...
Examples::
    ...
    xy-mid-360-s configure --ip 192.168.1.115 --host-ip 192.168.1.5
    xy-mid-360-s mode set sampling --ip 192.168.1.115
    xy-mid-360-s stream --seconds 10 --host-ip 192.168.1.5
...
from xy_mid_360_s.discovery import discover_subnet, query_sn
