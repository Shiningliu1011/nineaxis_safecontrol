...
against the pinned upstream sources vendored in the originating project's
scratch tree: ``livox_ros_driver2`` 1.2.6 (``src/comm/comm.h``, ``src/comm/pub_handler.cpp``)
